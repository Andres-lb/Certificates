@extends('layouts.app')
         <title>@yield('page_title','Add Certification')</title>
@section('content')
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" method="POST" action="{{ route('certificates.store') }}">
                @csrf
                ...
                <!-- Certification name //required -->
                  ...
                  <!-- Certification Awarding body//required -->
                    ...
                    <x-form1.drop-down current="{{  old('awarding') }}" label="Certification awarding body *" />


                  <!-- cim fees -->
                  <x-form1.cim label="CIM registration fees *" value="{{ old('fees') }}" />
                  ...
                  <div class="align-items-center mb-4">
                  <x-form1.switch label="Is Published" name="Is_published" value="{{  old('Is_published') }}"   />
                  </div>
